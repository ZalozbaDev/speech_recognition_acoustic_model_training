...
if [ $# != 6 ]; then
  echo "Usage: steps/train_mono.sh [options] <data-dir> <lang-dir> <exp-dir> <totgauss>"
  echo " e.g.: steps/train_mono.sh data/train.1k data/lang exp/mono 1000"
...
apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/1/utt2spk scp:$sdata/1/cmvn.scp scp:$sdata/1/feats.scp ark:- | add-deltas $delta_opts ark:- ark:- | copy-feats --binary=false ark:- ark,t:$sdata/1/p_debug.ark
copy-feats --binary=false scp:$sdata/1/feats.scp ark,t:$sdata/1/o_debug.ark
